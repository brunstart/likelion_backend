        ...
        while(true){
            ...
            switch(num){
                case 1:
                    ...
                    try(
                            PrintWriter pw = new PrintWriter(new FileWriter("src/Java.day13_250904/result.txt", true))
                        )
                    {
                ...
                case 2:
                    String memo;
                    try(BufferedReader br = new BufferedReader(new FileReader("src/Java.day13_250904/result.txt")))
                    {
